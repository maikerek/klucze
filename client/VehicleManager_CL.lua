...
function newVehicle()
    ...
    rTable.lock = function()
        ...
        if(lockStatus <= 2)then
            ...
            ESX.ShowAdvancedNotification("NazwaRP", "Kluczyki", "Pojazd otwarty: "..tablice.."", "CHAR_LIFEINVADER", 1)
        ...
        elseif(lockStatus > 2)then
            ...
            local tablice = tostring(string.upper(plate))
            ESX.ShowAdvancedNotification("NazwaRP", "Kluczyki", "Pojazd zamknięty: "..tablice.."", "CHAR_LIFEINVADER", 1)
